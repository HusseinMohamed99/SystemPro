...
class _ApiService implements ApiService {
  _ApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://sienna-woodpecker-844567.hostingersite.com/';
  }
  ...
  Future<CheckOtpResponse> checkOtp(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(checkOtpRequestBody.toJson());
  ...
  @override
  Future<ApiSuccessModel> logout() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiSuccessModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/mobile/logout',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiSuccessModel _value;
    try {
      _value = ApiSuccessModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ApiSuccessModel> deleteAccount() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<MarketplaceResponse> getMarketplaceListings({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MarketplaceResponse _value;
    try {
      _value = MarketplaceResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ToggleFavoriteResponse> toggleFavorite(int listingId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<GetFavoritesResponse> getFavoriteListings() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetFavoritesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<CategoryResponse> getCategories({
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'with_subcategories': withSubcategories,
    };
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
