...
abstract class _$$ForgotPasswordErrorImplCopyWith<T, $Res> {
  factory _$$ForgotPasswordErrorImplCopyWith(
    _$ForgotPasswordErrorImpl<T> value,
...
class __$$ForgotPasswordErrorImplCopyWithImpl<T, $Res>
    extends
        _$ForgotPasswordStateCopyWithImpl<T, $Res, _$ForgotPasswordErrorImpl<T>>
    implements _$$ForgotPasswordErrorImplCopyWith<T, $Res> {
  __$$ForgotPasswordErrorImplCopyWithImpl(
    _$ForgotPasswordErrorImpl<T> _value,
...
class _$ForgotPasswordErrorImpl<T> implements ForgotPasswordError<T> {
  ...
  @override
  String toString() {
    return 'ForgotPasswordState<$T>.forgotPasswordError(error: $error)';
  }
  ...
  get copyWith =>
      __$$ForgotPasswordErrorImplCopyWithImpl<T, _$ForgotPasswordErrorImpl<T>>(
        this,
        _$identity,
      );
...
abstract class ForgotPasswordError<T> implements ForgotPasswordState<T> {
  const factory ForgotPasswordError({required final String error}) =
      _$ForgotPasswordErrorImpl<T>;
