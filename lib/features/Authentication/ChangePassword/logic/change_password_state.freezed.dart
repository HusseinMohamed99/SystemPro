...
class _$ChangePasswordLoadingImpl<T> implements ChangePasswordLoading<T> {
  ...
  @override
  String toString() {
    return 'ChangePasswordState<$T>.changePasswordLoading()';
  }
...
class _$ChangePasswordSuccessImpl<T> implements ChangePasswordSuccess<T> {
  ...
  @override
  String toString() {
    return 'ChangePasswordState<$T>.changePasswordSuccess(data: $data)';
  }
...
abstract class _$$ChangePasswordErrorImplCopyWith<T, $Res> {
  factory _$$ChangePasswordErrorImplCopyWith(
    _$ChangePasswordErrorImpl<T> value,
...
class __$$ChangePasswordErrorImplCopyWithImpl<T, $Res>
    extends
        _$ChangePasswordStateCopyWithImpl<T, $Res, _$ChangePasswordErrorImpl<T>>
    implements _$$ChangePasswordErrorImplCopyWith<T, $Res> {
  __$$ChangePasswordErrorImplCopyWithImpl(
    _$ChangePasswordErrorImpl<T> _value,
...
class _$ChangePasswordErrorImpl<T> implements ChangePasswordError<T> {
  ...
  @override
  String toString() {
    return 'ChangePasswordState<$T>.changePasswordError(error: $error)';
  }
  ...
  get copyWith =>
      __$$ChangePasswordErrorImplCopyWithImpl<T, _$ChangePasswordErrorImpl<T>>(
        this,
        _$identity,
      );
